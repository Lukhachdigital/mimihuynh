...
const Button = ({ children, className = '', variant = 'primary', ...props }) => {
  ...
  const variantStyles = {
    primary: 'bg-amber-600 text-white hover:bg-amber-700 focus:ring-yellow-500',
    secondary: 'bg-slate-600 text-white hover:bg-slate-700 focus:ring-slate-500',
    danger: 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500',
    active: 'bg-amber-600 text-white ring-2 ring-yellow-400',
  };
...
const TrendImageGeneratorTab = ({ apiKey }) => {
  ...
  const themeTextAreaProps: React.TextareaHTMLAttributes<HTMLTextAreaElement> = {
    id: "theme-textarea",
    className: "w-full h-32 bg-slate-800 text-white border border-slate-600 rounded-md p-2 font-mono text-sm focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition",
  ...
  const creativeNotesTextAreaProps: React.TextareaHTMLAttributes<HTMLTextAreaElement> = {
    ...
    className: "w-full h-24 bg-slate-800 text-white border border-slate-600 rounded-md p-2 font-mono text-sm focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition",
